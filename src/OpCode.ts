export enum OpCode {
    ...
    OpStack_Pop = 'OpStack_Pop',
    OpStack_RemoveNextNext = 'OpStack_RemoveNextNext',
    ...
    ValStack_PopFrameAndMakeOperandStack = 'ValStack_PopFrameAndMakeOperandStack',
    ...
    Ctrl_ApplyMapVectorToBuilder = 'Ctrl_ApplyMapVectorToBuilder',
    Ctrl_Jump = 'Ctrl_Jump',
