...
export class FiberScheduleHandler {
  public static RunCurrentFiberToIdle(knState: KnState, opContState : Instruction) {
    knState.FiberMgr.CurrentFiberToIdle();
  }

  public static RunCurrentFiberToSuspended(knState: KnState, opContState : Instruction) {
    knState.FiberMgr.SuspendCurrentFiber();
  }

  public static RunAwakenMultiFibers(knState: KnState, opContState : Instruction) {
  ...
  public static RunYieldToParentAndChangeCurrentFiberState(knState: KnState, opContState : Instruction) {
  ...
  public static RunYieldToFiberAndChangeCurrentFiberState(knState: KnState, opContState : Instruction) {
  ...
  public static RunFinalizeFiber(knState: KnState, opContState : Instruction) {
    let currentFiber = knState.GetCurrentFiber();
