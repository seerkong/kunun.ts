...
export class JsCallHandler {
  public static ExpandJsCall(knState: KnState, nodeToRun: any) {
    ...
    knState.AddOp(KnOpCode.Ctrl_JsCall);
    knState.OpBatchCommit();
  }

  public static RunJsCall(knState: KnState, opContState : Instruction) {
